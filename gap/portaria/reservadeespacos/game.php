...
<head>
	...
	<title>Reserva do Game/Teen</title>
</head>
<body>
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultargame.php">Consultar Reserva do Game/Teen</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultargame.php" method="POST">
			<h1>Reserva do Game/Teen</h1>
			<fieldset>
				<div class="container">
		...
		<img src="imgs/game.webp" alt="Registro">
	</section>
</div>
