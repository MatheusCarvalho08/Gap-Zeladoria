...
<head>
	...
	<title>Reserva do Espaço Gourmet</title>
</head>
<body>
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultargourmet.php">Consultar Reserva do Espaço Gourmet</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultargourmet.php" method="POST">
			<h1>Reserva do Espaço Gourmet</h1>
			<fieldset>
				<div class="container">
		...
		<img src="imgs/gourmet.png" alt="Registro">
	</section>
</div>
