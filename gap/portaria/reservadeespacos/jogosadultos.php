...
<head>
	...
	<title>Reserva de Jogos Adultos</title>
</head>
<body>
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultarjogos.php">Consulta da Reserva de Jogos Adultos</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultarjogos.php" method="POST">
			<h1>Reserva de Jogos Adultos</h1>
			<fieldset>
				<div class="container">
		...
		<img src="imgs/jogo.png" alt="Registro">
	</section>
</div>
