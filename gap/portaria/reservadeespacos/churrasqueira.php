	...
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultarchurras.php">Consultar Reserva da Churrasqueira</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultarchurras.php" method="POST">
			<h1>Reserva da Churrasqueira</h1>
			<fieldset>
				<div class="container">
		...
		<img src="imgs/churras.png" alt="Registro">
	</section>
</div>
