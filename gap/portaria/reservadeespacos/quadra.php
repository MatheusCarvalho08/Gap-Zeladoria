	...
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultarquadra.php">Consultar Reserva da Quadra</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultarquadra.php" method="POST">
		...
		<img src="imgs/quadra.png" alt="Registro">
	</section>
</div>
