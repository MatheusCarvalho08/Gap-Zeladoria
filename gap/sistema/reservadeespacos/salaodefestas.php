...
<head>
	...
	<title>Reserva de Salão de Festas/Jogos</title>
</head>
<body>
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultarsalaodefestas.php">Consultar Reserva do Salão de festas</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultarsalaodefestas.php" method="POST">
		...
		<img src="imgs/calendario.png" alt="Registro">
	</section>
</div>
