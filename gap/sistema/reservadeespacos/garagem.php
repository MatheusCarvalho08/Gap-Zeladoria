...
<head>
	...
	<title>Reserva da Garage Band</title>
</head>
<body>
	<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				...
				<li class="nav-item"><a href="consultargaragem.php">Consultar Reserva da Garage Band</a></li>
            </ul>
            <div class="sair-menu">
...
<div class="main">
	<section>
		<form action="consultargaragem.php" method="POST">
			<h1>Reserva da Garage Band</h1>
			<fieldset>
				<div class="container">
		...
		<img src="imgs/garagem.png" alt="Registro">
	</section>
</div>
