...
<head>
  ...
  <title>Consultar Home Theater</title>
</head>
<body>
<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				<li class="nav-item"><a href="/gap/sistema/consultarespacos.php">Consultar Reservas</a></li>
                <li class="nav-item"><a href="/gap/sistema/index.php">Início</a></li>
                <li class="nav-item"><a href="/gap/sistema/reservadeespacos/home_espaco.php">Cadastrar/Consultar Home Theater</a></li>
            </ul>
            <div class="sair-menu">
...
<center><div class="main">
    <br>
    <h1>Consultar Solicitação/Check List</h1>
    <div class="conteiner">
        <a href="consultasolicitacao.php" class="btn">Consultar Solicitação de Uso <br> do Home Theater</a>
        <a href="consultahome.php" class="btn">Consultar Check List <br>de Patrimônio</a>
    </div>
</div></center>     
<br>
<!--===== FOOTER - 6 Parte =====-->
