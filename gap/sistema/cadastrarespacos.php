...
<header>
        <nav class="navigation">
            ...
            <ul class="nav-menu">
				<li class="nav-item"><a href="consultarespacos.php">Consultar Reservas</a></li>
...
<center><div class="main">
    ...
    <div class="conteiner">
        <a href="reservadeespacos/salaodefestas.php" class="btn">Salão de festas</a>
        <a href="reservadeespacos/espacogourmet.php" class="btn">Espaço Gourmet</a>
        <a href="reservadeespacos/churrasqueira.php" class="btn">Churrasqueira</a>
        <a href="reservadeespacos/home_espaco.php" class="btn">Home Theater</a>
        <a href="reservadeespacos/jogosadultos.php" class="btn">Jogos Adultos</a>
        <a href="reservadeespacos/game.php" class="btn">Game/Teen</a>
        <a href="reservadeespacos/espacomulher.php" class="btn">Espaço Mulher</a>
        <a href="reservadeespacos/garagem.php" class="btn">Garage Band</a>
        <a href="reservadeespacos/quadra.php" class="btn">Quadra</a>
    </div>
</div></center>     
<br>
<!--===== FOOTER - 6 Parte =====-->
