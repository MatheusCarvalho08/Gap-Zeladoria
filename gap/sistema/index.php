...
<body>
    ...
    <main>
        <section class="home">
            <div class="home-text">
                ...
                <h1 class="text-h1">A Página de </h1>
                <h1 class="text-h1">Administrador</h1>
    ...
    <div class="titulo" id="adm">
        <center><h1>Administração</h1></center>
    </div>
    <br><br><br><br>
    <center><fieldset>
        <legend><b>Portaria</b></legend>
            ...
            <div class="conteiner">
                ...
                <a href="unidades.php"><i class='bx bxs-home-alt-2'></i><br>Consultar Unidades</a>
            ...
            <div class="conteiner">
                ...
                <a href="feedbacks.php"><i class='bx bx-message-dots'></i><br>Consultar Feedbacks</a>
                <a href="consultaocorrencia.php"><i class='bx bxs-alarm-exclamation'></i><br>Consultar Ocorrência</a>
            </div>
            <div class="conteiner">
                <a href="bateponto.php"><i class='bx bxs-timer'></i><br>Salvar <br>Bate Ponto</a>
                <a href="consultarbateponto.php"><i class='bx bx-timer' ></i><br>Consultar <br>Bate Ponto</a>
            </div>
            <br>
    </fieldset></center>
<br><br><br><br><br><br><br>
    ...
    <section class="feedbacks">
        ...
        <center> <form action="/gap/sistema/index.php" method="POST" class="feedbacks__form">
